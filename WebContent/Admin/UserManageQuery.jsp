...
<body class="write_bg">
 <form name="form1" method="post" action="../userAdmin" target="_self">
    ...
    <td width="835" background="../images/wb_01 (3).jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="553" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#dadada" bgcolor="#FFFFFF">
          ...
          <c:forEach items="${subList }" var="user" varStatus="num">
          	<tr align="center" bgcolor="#FFFFFF">
            <td bordercolor="#FFFFFF"   class="text_cray1"><input type="checkbox" name="checkbox" value="${user.username }">            </td>
            <td width="98" bordercolor="#FFFFFF"  class="text_cray1">${user.username }</td>
            <td width="80" bordercolor="#FFFFFF"  class="text_cray1">${ user.sex eq "M"?"男":"女" }</td>
            <td width="132" bordercolor="#FFFFFF"  class="text_cray1">${user.certType.content }</td>
            <td width="247" bordercolor="#FFFFFF"  class="text_cray1">${ user.cert }</td>
            <td width="82" bordercolor="#FFFFFF"  class="text_cray1">${ user.userType.content }</td>
            <td width="89" bordercolor="#FFFFFF"  class="text_cray1"><a href="../userEditServlet?userName=${user.username }" class="text_red" name="link">编辑</a></td>
          </tr>
      ...
      <br>
        <table width="773" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr align="center" style="width:60%">
            <td width="335" align="left"  class="text_cray">&nbsp;</td>
            <td width="284" align="center"  class="text_cray">>> <c:forEach begin="1" end="${pu.pageCount }" var="pageNum"><a href="../userAdmin?pageNum=${pageNum }" style="text-decoration:none" name="link">${pageNum }&nbsp;</a></c:forEach> &lt;&lt; </td>
