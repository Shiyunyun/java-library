<%@page import="com.text.util.DateUtil"%>
  ...
  <tr>
    <td colspan="2" valign="top"  ><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td align="left" class="text_cray"><%="M".equals(user.getSex())?"男":"女" %></td>
          </tr>
          <tr>
            <td width="20" height="40" align="center" class="text_red">*</td>
            <td width="100" height="40" align="left" class="text_cray1">省份：</td>
            <td align="left" class="text_cray"><%=user.getProvince().getProvince() %></td>
          </tr>
          <tr>
            <td width="20" height="40" align="center" class="text_red">*</td>
          ...
          <tr>
            ...
            <td colspan="2" align="left" class="text_cray"><%=user.getCert_type()==1?"二代身份证":(user.getCert_type()==2?"港澳通行证":(user.getCert_type()==3?"台湾通行证":"护照")) %></td>
          </tr>
          <tr>
            <td width="20" height="40" align="center" class="text_red">*</td>
          ...
          <tr>
            ...
            <td colspan="2" align="left" class="text_cray"><%=DateUtil.formats(user.getBirthday())%></td>
          </tr>
          <tr>
            <td width="20" height="40" ></td>
            <td width="100" height="40" align="left" class="text_cray1">旅客类型：</td>
            <td colspan="3" align="left" class="text_cray"><%=user.getUser_type()==1?"成人":(user.getUser_type()==2?"儿童":(user.getUser_type()==3?"学生":"残疾军人、伤残人民警察")) %></td>
          </tr>
          <tr>
            <td width="20" height="40"></td>
