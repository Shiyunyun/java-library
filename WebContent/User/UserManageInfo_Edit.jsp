...
<body class="write_bg">
<form name="form1" method="post" action="../userUpload" target="_self" enctype="multipart/form-data">
      ...
      <tr>
        ...
        <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td align="left" class="text_cray1"><input name="textfield2" type="text" disabled="true" class="text_cray" id="textfield2" value="${ user.realName }" readonly="readonly"/></td>
          </tr>
          <tr>
            <td width="20" ></td>
            <td width="100" height="30" align="left" class="text_cray1">性 别：</td>
            <td align="left" class="text_cray1">
              <input type="radio" name="userDTO.sex_code" value="M" readonly="readonly" disabled="true" ${ user.sex eq "M"?"checked":"" }/>
          <span class="text_cray">
              <label>男</label>
              <input type="radio" name="userDTO.sex_code" value="F" readonly="readonly" disabled="true" ${ user.sex eq "F"?"checked":"" }/>
              <label>女</label>
              </span>
              <label></label>
<span><label></label>
          ...
          <tr>
            ...
            <td align="left" class="text_cray1"><input name="textfield2" type="text" disabled="true" class="text_cray" id="textfield2" value="${user.province.getProvince() }" readonly="readonly"/>            </td>
          </tr>
          <tr>
            <td width="20" align="center" class="text_red">*</td>
            <td width="100" height="40" align="left" class="text_cray1">城市：</td>
            <td align="left" class="text_cray1"><input name="textfield2" type="text" disabled="true" class="text_cray" id="textfield2" value="${user.city.getCity() }" readonly="readonly"/>            </td>
          </tr>
          <tr>
            <td width="20" align="center" class="text_red">*</td>
            <td width="100" height="40" align="left" class="text_cray1">证件类型：</td>
            <td align="left" class="text_cray1"><input name="textfield2" type="text" disabled="true" class="text_cray" id="textfield2" value="${ user.cert_type eq 1?"二代身份证":user.cert_type eq 2?"港澳通行证":user.cert_type eq 3?"台湾通行证":"护照"}" readonly="readonly"/>            </td>
          </tr>
          <tr>
            <td width="20" align="center" class="text_red">*</td>
            <td width="100" height="40" align="left" class="text_cray1">证件号码：</td>
            <td align="left" class="text_cray1"><input name="textfield6" type="text" disabled="disabled" class="text_cray" id="textfield6"  value="${ user.cert }" readonly="true"/></td>
          </tr>
          <tr>
            <td width="20" align="center" class="text_red">*</td>
            <td width="100" height="40" align="left" class="text_cray1">出生日期：</td>
            <td colspan="2" align="left" class="text_cray1"><input name="textfield7" type="text" disabled="disabled" class="text_cray" id="textfield7" value="${ user.birthday }" readonly="true"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="80" colspan="2" align="left" class="text_cray1"><textarea name="textarea" rows="8" class="text_cray" style="width:100%">${ user.content }</textarea>            </td>
          </tr>
        </table><br>
