...
<table width="100%" border="0" cellspacing="0">
  <tr>
    ...
    <td width="140" valign="top" bgcolor="#deedf8" class="text_cray1">欢迎您，<%=user.getUsername() %></td>
    <td width="64" align="left" valign="top" bgcolor="#deedf8"><a href="<%=basePath%>exitServlet" target="_top" class="cray">退出</a></td>
  </tr>
</table>
